...
public class DeptManager {
    ...
    private eseo.fr.robineau.backend.Employee empNo;
    ...
    public eseo.fr.robineau.backend.Employee getEmpNo() {
        return empNo;
    }

    public void setEmpNo(eseo.fr.robineau.backend.Employee empNo) {
        this.empNo = empNo;
    }
